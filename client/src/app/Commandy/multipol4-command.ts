...
export class Multipol4Command implements Command{
  ...
  constructor(meno,fake1meno,fake2meno,fake3meno,fake4meno,type){
    ...
    this.create_dangling_edges(fake1meno,fake2meno,fake3meno,fake4meno);
  ...
  create_dangling_edges(fake1meno,fake2meno,fake3meno,fake4meno){
  ...
  execute() {
    if(this.prvykrat){
      ...
      Informacie.poleMultipolov[this.multipol.name][5].set("left",this.multipol.suradnicaLeft);
      Informacie.poleMultipolov[this.multipol.name][5].set("top",this.multipol.suradnicaTop);
