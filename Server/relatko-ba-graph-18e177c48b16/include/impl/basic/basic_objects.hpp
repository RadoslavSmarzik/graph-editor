...
std::vector<Loc> Locs(const std::vector<Loc> locs) {return locs;}
std::vector<Loc> Locations(const std::vector<Loc> locs) {return locs;}
...
std::vector<Dir> Dirs(const std::vector<Dir> locs) {return locs;}
std::vector<Dir> Directions(const std::vector<Dir> locs) {return locs;}
