...
namespace IP {
    ...
    class all {
    public:
        bool operator() (const Incidence &a) {(void)a; return true;};
    };

    class primary {
    public:
        primary() {}
        bool operator() (const Incidence &a) {return a.is_primary();};
    };

    class loop {
    public:
        loop() {}
        bool operator() (const Incidence &a) {return a.is_loop();};
    };
    ...
    public:
        ith(int i): i_(i) {}
        bool operator() (const Incidence &) {if (i_--) return false; return true;};
    };
    ...
    public:
        n2(Number n) :n_(n) {}
        bool operator() (const Incidence &i) {return i.n2()==n_;};
    };
    class v2 {
        Vertex v_;
    public:
        v2(Vertex v) :v_(v) {}
        bool operator() (const Incidence &i) {return i.v2()==v_;};
    };
    class e {
        Edge e_;
    public:
    ...
    public:
        h1(HalfEdge h) :h_(h) {}
        bool operator() (const Incidence &i) {return i.h1()==h_;};
    };
    class h2 {
        HalfEdge h_;
    public:
        h2(HalfEdge h) :h_(h) {}
        bool operator() (const Incidence &i) {return i.h2()==h_;};
    };
    ...
    public:
        ...
        bool operator() (const Incidence &i) {return i.r2().degree()==cnt_;};
    };
    ...
    public:
        count() :cnt_(0) {}
        bool operator() (const Incidence &) {cnt_++; return true;};
...
namespace IT {
    ...
    public:
        iterator() {}
        IncidenceIterator operator() (IncidenceIterator it) { return it; }
    };

    class n2 {
    public:
        n2() {}
        Number operator() (IncidenceIterator it) { return it->n2(); }
    };

    class v2 {
    public:
        v2() {}
        Vertex operator() (IncidenceIterator it) { return it->v2(); }
    };

    class e {
    public:
        e() {}
        Edge operator() (IncidenceIterator it) { return it->e(); }
    };

    class h1 {
    public:
        h1() {}
        HalfEdge operator() (IncidenceIterator it) { return it->h1(); }
    };

    class h2 {
    public:
        h2() {}
        HalfEdge operator() (IncidenceIterator it) { return it->h2(); }
    };
    ...
    public:
        r1() {}
        Rotation& operator() (IncidenceIterator it) { return it->r1(); }
    };
    class r2 {
    public:
        r2() {}
        Rotation& operator() (IncidenceIterator it) { return it->r2(); }
    };
...
namespace IC {
    ...
    public:
        n1() {}
        bool operator() (IncidenceIterator it1, IncidenceIterator it2) { return it1->n1()<it2->n1(); }
    };
    class n2 {
    public:
        n2() {}
        bool operator() (IncidenceIterator it1, IncidenceIterator it2) { return it1->n2()<it2->n2(); }
    };
    class degree1 {
    public:
        degree1() {}
        bool operator() (IncidenceIterator it1, IncidenceIterator it2) { return it1->r1().degree()<it2->r1().degree(); }
    };
    class degree2 {
    public:
        degree2() {}
        bool operator() (IncidenceIterator it1, IncidenceIterator it2) { return it1->r2().degree()<it2->r2().degree(); }
    };

    class e {
    public:
        e() {}
        bool operator() (IncidenceIterator it1, IncidenceIterator it2) { return it1->e()<it2->e(); }
    };
    ...
    public:
        ...
        bool operator() (IncidenceIterator it1, IncidenceIterator it2) {
