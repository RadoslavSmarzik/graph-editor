...
Graph &remove_loops(Graph &G, Number v, Factory &f = static_factory)
{
...
Graph &remove_loops(Graph &G, Factory &f = static_factory)
{
#ifdef BA_GRAPH_DEBUG
    assert(check(G, f));
#endif
...
Graph &remove_parallel_edges(Graph &G, Factory &f = static_factory)
{
#ifdef BA_GRAPH_DEBUG
    assert(check(G, f));
#endif
...
Graph &simplify(Graph &G, Factory &f = static_factory)
{
#ifdef BA_GRAPH_DEBUG
    assert(check(G, f));
#endif
