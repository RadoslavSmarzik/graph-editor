...
Graph &two_product(Graph &G1, const Location &l1,
...
Graph &three_product(Graph &G1, Number v1, std::vector<Number> neighbours1,
...
Graph &dot_product(Graph &G, const Location &l21, const Location &l22,
...
Graph &star_product(Graph &G, std::vector<Number> v,
