...
bool is_circularly_colourable_sat(const SatSolver &solver, const Graph &G, int p, int q,
...
bool is_circularly_edge_colourable_sat(const SatSolver &solver, const Graph &G, int p, int q,
...
std::pair<int, int> circular_chromatic_number_sat(const SatSolver &solver, const Graph &G,
...
std::pair<int, int> circular_chromatic_index_sat(const SatSolver &solver, const Graph &G,
        std::ostream *reportProgressStream = NULL)
{
