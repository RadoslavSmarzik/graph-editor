...
// works for k > 0
bool has_circuit_sat(SatSolver solver, const Graph &G, int k, Number w=-1)
{
...
bool is_hamiltonian_sat(SatSolver solver, const Graph &G)
{
...
int circumference_sat(SatSolver solver, const Graph &G)
{
