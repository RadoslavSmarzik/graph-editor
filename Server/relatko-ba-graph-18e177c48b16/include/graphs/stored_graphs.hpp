...
std::string stored_cubic_dir(int cc, int g)
{
	std::stringstream ss;
	ss << "cubic/";
	ss << std::setfill('0');
...
std::string stored_cubic_file(int cc, int g, int order)
{
	std::stringstream ss;
	ss << std::setfill('0');
	ss << "cubic_cc" << std::setw(2) << cc;
...
std::string stored_cubic_path(int cc, int g, int order)
{
	return stored_cubic_dir(cc, g) + "/" + stored_cubic_file(cc, g, order);
}

std::string stored_snark_dir(int cc, int g)
{
	std::stringstream ss;
	ss << "snarks/";
	ss << std::setfill('0');
...
std::string stored_snark_file(int cc, int g, int order)
{
	std::stringstream ss;
...
std::string stored_snark_path(int cc, int g, int order)
{
