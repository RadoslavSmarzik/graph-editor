...
bool is_colourable_basic(const Graph &G, int k,
...
bool is_colourable_basic(const Graph &G, int k, bool precolour = true)
{
...
bool is_edge_colourable_basic(const Graph &G, int k,
...
bool is_edge_colourable_basic(const Graph &G, int k, bool precolour = true)
{
    Factory f;
    auto [H, edgeToVertex] = line_graph_with_map(G, f);
    VertexLabeling<int> lgPrecolouring(-1);
...
int chromatic_number_basic(const Graph &g)
{
...
int chromatic_index_basic(const Graph &g)
{
